...
.set	WKF_SECTOR_SIZE,	0x20
.set 	WKF_SECTOR,			(0x81800000-WKF_SECTOR_SIZE)
.set 	DECODE_WORK_AREA,	(WKF_SECTOR-CHUNK_48to32)
...
#define WKF_SECTOR_SIZE		0x20
#define WKF_SECTOR			(0x81800000-WKF_SECTOR_SIZE)
#define DECODE_WORK_AREA	(WKF_SECTOR-CHUNK_48to32)
